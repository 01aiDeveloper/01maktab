        ...
        <section className="container pt-8 pb-4">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4">
            ...
            >
              <Link
                href="/"
                className="lg:hidden pt-4 pl-4 inline-flex items-center gap-2 text-[#18181A]/50 hover:text-[#18181A] transition-colors text-sm mb-3"
              >
            ...
            <div className="relative bg-linear-to-br from-[#111] to-[#1a1a1a] rounded-3xl p-7 lg:p-8 flex flex-col justify-between h-50 lg:h-60">
              <Link
                href="/"
                className="hidden lg:inline-flex items-center gap-2 text-white/50 hover:text-white transition-colors text-sm w-fit"
              >
                <ArrowLeft className="w-4 h-4" />
                <span>Orqaga</span>
              </Link>
