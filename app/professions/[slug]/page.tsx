  ...
  const staticBenefits = [
    {
      ...
      icon: <Image quality={100} src="/icons/professions/1.webp" alt="" width={80} height={80} className="opacity-40 grayscale" />,
    ...
    },
    {
      ...
      icon: <Image quality={100} src="/icons/professions/2.webp" alt="" width={80} height={80} className="opacity-40 grayscale" />,
    },
    {
      id: 3,
      title: t('benefits.practice'),
      bullets: [t('benefits.practiceB1'), t('benefits.practiceB2')],
      icon: <Image quality={100} src="/icons/professions/3.webp" alt="" width={80} height={80} className="opacity-40 grayscale" />,
    },
    {
      id: 4,
      title: t('benefits.career'),
      bullets: [t('benefits.careerB1'), t('benefits.careerB2')],
      icon: <Image quality={100} src="/icons/professions/4.png" alt="" width={80} height={80} className="opacity-40 grayscale" />,
    },
    {
      id: 5,
      title: t('benefits.community'),
      bullets: [t('benefits.communityB1'), t('benefits.communityB2')],
      icon: <Image quality={100} src="/icons/professions/5.png" alt="" width={80} height={80} className="opacity-40 grayscale" />,
    },
    {
      id: 6,
      title: t('benefits.refund'),
      bullets: [t('benefits.refundB1'), t('benefits.refundB2')],
      icon: <Image quality={100} src="/icons/professions/6.png" alt="" width={80} height={80} className="opacity-40 grayscale" />,
    },
  ];
      ...
      <main>
        ...
        <section id="nima-organasiz" className="w-full">
          <div className="container mx-auto px-4 h-[511px] sm:h-[calc(100vh-90px)]">
            ...
            >
              {/* Background Image */}
              {courseImage && <Image quality={100} src={courseImage} alt={profession.title} fill sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" className="object-cover" priority />}
