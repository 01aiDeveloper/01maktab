          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col gap-4 lg:col-span-2">
              ...
              >
                ...
                <h1 className="font-suisse text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">{skill.title}</h1>
                ...
                {skillModules?.progress && skillModules.progress.totalLessonsCount > 0 ? (
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-xs bg-gray-100 text-gray-600 px-3 py-1.5 rounded-full">
                        Dars: {skillModules.progress.completedLessonsCount}/{skillModules.progress.totalLessonsCount}
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className="bg-[#5d7bf5] h-2 rounded-full transition-all duration-500"
                        style={{ width: `${Math.round((skillModules.progress.completedLessonsCount / skillModules.progress.totalLessonsCount) * 100)}%` }}
                      />
                    </div>
                    <MainButton
                      variant="gradient"
            ...
            >
              <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                <div className="flex-1 text-white">
                  <h2 className="font-suisse text-2xl lg:text-4xl font-bold mb-4">{partner.name} bilan hamkorlikda</h2>
                ...
                <div className="w-full lg:w-80 shrink-0">
                  <div className="bg-white rounded-2xl p-8 lg:p-12 flex items-center justify-center aspect-square lg:aspect-auto lg:h-64">
                    {partner.logo ? (
                      <Image src={mediaUrl(partner.logo)} alt={partner.name} width={150} height={150} className="object-contain" />
                    ) : (
