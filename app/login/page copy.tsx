        ...
        <>
          ...
          {step === 'TELEGRAM_OTP' ? (
            <>
              ...
              <p className="text-sm text-gray-500 mb-4 text-center">Telegram botdan olingan 6 raqamli kodni kiriting</p>
              ...
              <button
                ...
                className={cn(
                  ...
                  telegramOtp.join('').length === 6 && !isVerifying ? 'bg-gray-900 text-white' : 'bg-gray-200 text-gray-400 cursor-not-allowed'
                )}
              ...
              <button onClick={() => setStep('INITIAL')} className="text-sm text-gray-400 hover:text-gray-600 transition-colors">
                Orqaga qaytish
              </button>
            </>
          ) : (
            <>
              <h2 className="text-xl font-medium text-gray-800 mb-8">Tizimga kirish</h2>
