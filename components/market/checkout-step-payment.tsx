      ...
      <div className="flex gap-5 mb-6">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            {isCoin ? (
              <Image quality={90} src="/images/market/VC.png" alt="VC" width={18} height={24} className="w-5 h-6" />
            ) : (
        ...
        {product.images[0] && (
          <div className="w-[122px] h-[119px] sm:w-[244px] sm:h-[238px] rounded-2xl overflow-hidden flex-shrink-0 bg-gray-100">
            <Image
              quality={90} src={product.images[0]}
              alt={product.title}
              width={244}
              height={238}
        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            {(['click', 'payme', 'uzum'] as PaymentProvider[]).map((provider) => (
              ...
              >
                <Image
                  quality={90} src={`/icons/payment/${provider}.svg`}
                  alt={provider}
                  width={72}
                  height={28}
