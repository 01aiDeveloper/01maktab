...
export function SiteFooter() {
  return (
    <footer className="container pt-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-6 border-t border-border/40">
        {/* Navigation links */}
      ...
      >
        <h2 className="text-[clamp(5rem,20vw,18rem)] font-bold leading-[0.85] tracking-tighter text-foreground">
          01Maktab
        </h2>
      </motion.div>
    </footer>
