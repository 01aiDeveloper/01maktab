      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[300px] lg:min-h-[500px] bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center">
            <Image quality={90} src="/icons/professions/bg.gif" alt="Live mentoring" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            ...
            <div className="relative z-10">
              <Image
                quality={90} src="/images/professions/mentor-communication.webp"
