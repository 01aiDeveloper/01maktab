    ...
    <section className="container py-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="rounded-3xl overflow-hidden min-h-[220px]">
          <Image quality={100} src="/images/team1.png" alt="01AI jamoasi" width={600} height={400} className="w-full h-full object-cover" />
        </motion.div>

        {/* Row 2 */}
        {/* Team photo 2 - left side of row 2 */}
        <motion.div variants={itemVariants} className="rounded-3xl overflow-hidden min-h-[220px]">
          <Image quality={100} src="/images/team2.png" alt="Jamoa ishlayapti" width={600} height={400} className="w-full h-full object-cover" />
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="bg-[#e8e8e8] rounded-3xl p-6 flex items-center justify-center min-h-[200px]">
          <Image quality={100} src="/images/3d-cylinder.jpg" alt="3D illustration" width={200} height={200} className="object-contain max-h-[180px]" />
        </motion.div>
