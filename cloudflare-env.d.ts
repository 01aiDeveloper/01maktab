/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 9419c899281aff78f14a267858b5fcf8)
// Runtime types generated with workerd@1.20260910.1 2026-09-10 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXT_INC_CACHE_KV: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXT_PUBLIC_API_BASE_URL: "https://app-dev.01ai.uz/api/v1";
	NEXT_PUBLIC_UPLOAD_URL: "https://maktab01-dev-files.s3.eu-north-1.amazonaws.com";
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* 01-user-pannel */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_API_BASE_URL" | "NEXT_PUBLIC_UPLOAD_URL" | "NEXTJS_ENV">> {}
}
