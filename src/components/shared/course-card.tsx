  ...
  return (
    <Link href={`/courses/${courseSlug}`} className="block group h-full">
      <motion.div
        ...
        className="relative w-full aspect-[654/430] overflow-hidden rounded-[24px] md:rounded-[32px] shadow-[0_10px_24px_rgba(24,38,86,0.08)] hover:shadow-[0_20px_35px_rgba(24,38,86,0.16)] bg-gradient-to-br from-[#3B5BFF] to-[#2A3F8F] cursor-pointer transition-shadow duration-300"
      >
        <Image
          quality={90}
          src={imgSrc}
          alt={title}
          fill
          sizes="(max-width: 768px) 90vw, 654px"
