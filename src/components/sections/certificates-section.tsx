            ...
            {certificates.map((cert, index) => (
              ...
              >
                ...
                <div className="relative w-full aspect-[4/3]">
                  ...
                  {/* Background Image */}
                  <Image
                    quality={90} src={`/images/professions/certificate-bg${index + 1}.webp`}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-8 z-20">
                    <div className="relative w-full max-w-[300px] aspect-[4/3]">
                      <Image quality={90} src={cert.image} alt={cert.title} fill sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" className="object-contain drop-shadow-2xl" />
                    </div>
                  </div>
                </div>
