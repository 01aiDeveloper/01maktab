                ...
                <motion.div key={card.id} variants={cardVariants} className="flex-[0_0_80%] min-w-0 sm:flex-[0_0_calc(50%-8px)] lg:flex-none">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Image quality={90} src={card.image} alt={card.title} fill sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" className={`object-contain ${card.imagePosition}`} />
                      </div>
                    </div>
                  </motion.button>
                </motion.div>
