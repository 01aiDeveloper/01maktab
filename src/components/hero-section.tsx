      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-auto lg:h-[480px]">
          ...
          >
            ...
            <Image quality={90} src="/images/hero-img.png" alt="Friendly purple monster mascot" fill sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 33vw" className="object-cover object-center" priority />
          </motion.div>
        </div>
      </div>
    </section>
