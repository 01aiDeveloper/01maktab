    ...
    return (
      <div className="bg-white rounded-2xl p-10 lg:p-16 w-full text-center shadow-sm min-h-[480px] flex flex-col items-center justify-center">
          ...
          <div className="flex justify-center mb-5">
            <Image quality={90} src="/icons/file.svg" alt="" width={56} height={56} />
          </div>
      ...
      <div>
        ...
        {currentQuestion.image && (
          <div className="relative w-full max-h-56 rounded-xl mb-5 bg-gray-50 overflow-hidden">
            <Image
              quality={90} src={getMediaUrl(currentQuestion.image)}
              alt=""
              width={800}
              height={224}
          ...
          {currentQuestion.options.map((option, optIdx) => {
            ...
            if (isSingle) {
              ...
              return (
                ...
                >
                  ...
                  />
                  {option.image && (
                    <Image quality={90} src={getMediaUrl(option.image)} alt="" width={200} height={96} className="mt-1 max-h-24 object-contain rounded-lg" />
                  )}
                </label>
              );
            }
            ...
            return (
              ...
              >
                ...
                {option.image && (
                  <Image quality={90} src={getMediaUrl(option.image)} alt="" width={200} height={96} className="max-h-24 object-contain rounded-lg" />
                )}
              </div>
            );
          })}
